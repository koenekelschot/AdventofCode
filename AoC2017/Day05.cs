...
namespace AoC2017
{
    class Day05
    {
        public static void Part1()
        {
            ...
            //instruction marked in parentheses.The following steps would be taken before an exit is 
            //found:
            ...
            while (exitReached == false)
            {
                try
                {
                    var jumpTo = pos + Input[pos];
                    Input[pos]++;
                    jumps++;
                    pos = jumpTo;
                }
