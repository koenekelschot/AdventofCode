...
namespace AoC2017
{
    class Day25
    {
        public static void Part1()
        {
            ...
            //"It stopped milliseconds ago; not sure why. I'm a garbage collector, not a doctor." You ask what the machine 
            //is for. "Programs these days, don't know their origins. That's the Turing machine! It's what makes the whole 
            ...
            //You find the Turing machine blueprints (your puzzle input) on a tablet in a nearby pile of debris. Looking back 
            //up at the broken Turing machine above, you can start to identify its parts:
            ...
            for (var i = 0; i < steps; i++)
            {
                ...
                if (state == 'A')
                {
                    ...
                    {
                        tape[cursor] = 1;
                        MoveRight(ref tape, ref cursor);
                        state = 'B';
                    }
                    else
                    {
                        MoveLeft(ref tape, ref cursor);
                        state = 'E';
                    }
                }
                else if (state == 'B')
            ...
            Debug.WriteLine("Checksum: " + tape.Count(t => t == 1));
        }
        ...
        private static void MoveLeft(ref IList<int> tape, ref int cursor)
        {
            if (cursor > 0)
            {
                cursor--;
        ...
        private static void MoveRight(ref IList<int> tape, ref int cursor)
        {
            if (cursor == tape.Count - 1)
            {
                tape.Add(0);
            }
            cursor++;
